...
router.post('/login', async (req, res) => {
  try { 
    ...
    if (data && (await compare(b.password, data.password))) {
...
router.post('/create/admin', async (req, res) => {
  try {
    let b = req.body;
    b.password = await hashPassword(b.password); // Assuming you have a function to hash passwords
